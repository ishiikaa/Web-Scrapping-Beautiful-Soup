...
sheet.append([rate2, rate_s2, rev2])
#rating3
print('******3*******')
...
sheet.append([rate3, rate_s3, rev3])
...
sheet.append([rate4, rate_s4, rev4])
...
sheet.append([rate5, rate_s5, rev5])
...
sheet.append([rate6, rate_s6, rev6])
...
sheet.append([rate7, rate_s7, rev7])
...
sheet.append([rate8, rate_s8, rev8])
...
sheet.append([rate9, rate_s9, rev9])
...
sheet.append([rate10, rate_s10, rev10])

excel.save('Books2.xlsx')
